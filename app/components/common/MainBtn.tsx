...
const MainBtn = ({btnTxt}:MainBtnProps) => {
  return (
    <Link href="#" className="flex cursor-pointer items-center bg-primary hover:bg-primary/90 text-white w-fit font-medium px-5 py-2 rounded-[8px] space-x-5 text-xs leading-[1.87] uppercase group">
      <span>{btnTxt}</span>
