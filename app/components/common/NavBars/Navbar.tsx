...
const Navbar = () => {
  ...
  if (isMobile) {
    ...
    return (
      <header
        className={`transition duration-300 ease-in-out w-full top-0 z-50
          ${
            isScrolled
              ? "fixed left-0 bg-white backdrop-blur-[10px] text-black shadow-md"
              : hasBackground
              ? "relative bg-white backdrop-blur-[10px] text-black shadow-md"
