...
const PrimaryCard = ({crdImg,crdTitle,crdDesc}:crdProps) => {
  return ( 
    <div className="relative overflow-hidden rounded-xl border border-gray/20 group transition-all duration-300 cursor-pointer">
      ...
      <div className="p-4 lg:p-[30px] group-hover:bg-secondary transition-all duration-300">
        ...
        <p className="group-hover:text-white transition-colors duration-300">{crdDesc}</p>
      </div>
    </div>
   );
}
