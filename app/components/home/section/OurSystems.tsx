          ...
          {services.map((item, index) => (
            <div key={index}>
              <div className="relative group rounded-[20px] overflow-hidden h-full group bg-EFEFEF hover:bg-secondary hover:text-white flex flex-col  transition-all duration-500">
                ...
                <h3 className="text-32 font-medium leading-[1.3] text-black group-hover:text-white duration-400 transition-colors px-5 py-5 lg:px[28px] lg:py-8 ">{item.title}</h3>
