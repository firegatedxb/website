        ...
        viewport={{ once: true, amount: 0.3 }}
          >
            <Image
              ...
              width={399}
              height={381}
              className="w-full object-cover group-hover:scale-105 group-active:scale-105 transition-all duration-400"
            />
          </motion.div>

          <h3 className="text-32 font-medium leading-[1.3] text-black group-hover:text-white group-active:text-white duration-400 transition-colors px-5 pt-5 lg:px[28px] lg:pt-8">
            {item.title}
          </h3>
