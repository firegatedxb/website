  ...
  return (
    <section className="py[50px] md:py-[50px] lg:pt-[108px]  lg:pb-[78px] relative bg-EFEFEF">
      <div className="container">
        <div className=" ">
          <div className=" ">
            <h2 className="text-50 text-secondary font-medium mb-3 md:mb-8 uppercase">
    ...
    <SwiperSlide key={index}>
      <div className=" bg-white flex items-center justify-center rounded-[20px] h-[200px] md:h-[226px] lg:h-[286px] group">
        <Image
          ...
          className="     "
        />
        <div className="w-[50px] h-[50px] rounded-full border flex items-center justify-center absolute top-[10px] right-[10px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out  ">
