        ...
        <div className="flex md:gap-[45px] lg:gap-[108px] h-full">
          ...
          >
            <div className="lg:flex flex-col md:justify-between h-full">
              ...
              <div>
                <Link href="/projects">
                  <button className="flex mt-4 cursor-pointer items-center bg-primary hover:bg-primary/90 text-white w-fit font-medium px-5 py-2 rounded-[8px] space-x-5 text-xs leading-[1.87] uppercase group">
