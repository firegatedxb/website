        ...
        <div className="pt-[40px] md:pt-[70px] lg:pt-[100px] ">
          ...
          <div className="overflow-hidden   ">
            <div>
              ...
              style={{
               backgroundImage: `url(${assets.dmall.src})`
               ,
              }}>
              {/* <Image
                src={assets.dmall}
...
<div className="md:w-1/2 lg:w-1/3 flex flex-col gap-4 justify-between">
  <div className="flex flex-col gap-4 md:gap-8 justify-stretch h-full">
    {infoData.map((item, index) => (
      <div key={index} className="flex gap-4 md:gap-8 border-b pb-5 md:pb-8">
  ...
  <div className="lg:absolute bottom-8 md:bottom-[80px]">
    <div className="flex gap-4 md:gap-8">
      <Image src={footerData.icon} alt="Location" />
      <div>
        <p className="text-32 font-medium">{footerData.value}</p>
      </div>
    </div>
  </div>
</div>
