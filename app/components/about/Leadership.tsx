...
const Leadership = ({ data }: { data: About }) => {
  ...
  return (
    ...
    >
      ...
      <div className="border border-graylit h-fullcalc rounded-3xl z-[-1] transition duration-300 group-hover:shadow-lg xl:relative xl:bottom-[120px]">
