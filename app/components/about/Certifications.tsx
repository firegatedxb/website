      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-10">
          {certifications.map((item,index) => (
            <div className="border group border-[#cccccc]  transition duration-300 hover:shadow-lg  rounded-2xl max-h-[350px] overflow-hidden relative p-5 lg:p-10   transform hover:-translate-y-1 " key={index}>
              <div className="">
